//FXStreet.Global.RandomClient
const testVariable = Math.floor(Math.random() * 2);
const desiredIndex = testVariable % 2;
const brokerList = document.querySelector("#brokerList");
const brokersData = [
  {
    name: "Pepperstone",
    spreadsImageUrl:
  ...
  {
    name: "XM Group",
    spreadsImageUrl: "https://editorial.fxsstatic.com/brokers/xm_2025_Gran.png",
...
const brokerCardTemplate = (broker) => `
    <div class="broker-card">
            ...
            <div class="broker-top-right">
                <div class="broker-sponsored-wrapper">
                    <a 
                        ...
                        target="_blank"
                        rel="sponsored noopener noreferrer nofollow" 
                        class="broker-name-link">${broker.name}</a>
                        ${
                          broker.isPartner
                            ? '<div class="broker-partner">Sponsor</div>'
                            : ""
                        }
                </div>
        ...
        <a 
            ...
            target="_blank"
            rel="sponsored noopener noreferrer nofollow" 
            class="cta-button">Open account
        </a>
        <div class="disclosure">
            <input 
                type="checkbox" 
                id="toggle-disclosure-${broker.slug}" 
                class="disclosure-checkbox">
            <label 
                for="toggle-disclosure-${broker.slug}" 
...
const brokerRatingTemplate = (broker) => `
    <div class="broker-card">
        <div class="broker-details">
            <img src="${broker.spreadsImageUrl}" alt="${
  broker.name
}" class="logo">
            <span class="broker-name" title="${broker.name}">${
  broker.name
}</span>
        </div>
        <div class="chart-container">
            <div class="chart-item">
                ...
                <div class="chart-bar">
                    <div class="chart-bar-value" style="width: ${
                      broker.accountConditions * 10
                    }%;"> </div>
                </div>
            ...
            <div class="chart-item">
                ...
                <div class="chart-bar">
                    <div class="chart-bar-value" style="width: ${
                      broker.customerServiceSupport * 10
                    }%;"> </div>
                </div>
...
const template = desiredIndex === 0 ? brokerRatingTemplate : brokerCardTemplate;
let htmlBrokerList = "";
